...
def iDotScheduler():
    with gr.Blocks(
        theme="default",
        css="footer {visibility: hidden} .container {max-width: 1500px; margin: auto}",
    ) as app:
        with gr.Row():
            ...
            with gr.Column(scale=9):
                ...
                with gr.Row():
                    worklist_name = gr.Textbox(
                        label="Worklist Name", value="iDot Worklist"
                    )
                    user = gr.Textbox(label="User Name", value="John Doe")
                    plate_size = gr.Dropdown(
                        choices=[96, 384, 1536], value=1536, label="Plate Size"
                    )
                ...
                with gr.Row():
                    ...
                    source_name = gr.Textbox(
                        label="Source Plate Name", value="Source Plate 1"
                    )
